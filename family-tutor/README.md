...
Each learner keeps one durable `runs/family/<child-id>/memory.md`. ChatGPT owns tutor threads and conversation history; Family Tutor does not duplicate them into local session/transcript directories or a conversation state file.
