...
- Durable `AGENTS.md` remains intact.
...
- Any durable facts are written to that child's `AGENTS.md` before rollover.
...
- Durable learner context remains available through `AGENTS.md`.
