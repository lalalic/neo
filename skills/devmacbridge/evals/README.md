...
1. Missing nested checkout: clone upstream into `<skill-folder>/mac-developer-bridge`.
...
5. HTTP code update: restart only `macdevbridge-http` and preserve the tunnel hostname.
